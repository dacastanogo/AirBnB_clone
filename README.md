...
The above classes are handled by the abstracted storage engine defined in the  [FileStorage](https://github.com/bdbaraban/AirBnB_clone/blob/master/models/engine/file_storage.py)  class.
...
-   **Andrés Patiño**  <[apatinoc4](https://github.com/apatinoc4)>
-   **Daniel Castaño**  <[dacastanogo](https://github.com/dacastanogo)>